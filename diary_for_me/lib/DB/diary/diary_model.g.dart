...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  QueryBuilder<Tag, Tag, QAfterFilterCondition> countEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> countGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> countLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> countBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'count', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'count', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'count', Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  QueryBuilder<Tag, Tag, QDistinct> distinctByCount() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryProperty on QueryBuilder<Tag, Tag, QQueryProperty> {
  ...
  QueryBuilder<Tag, int, QQueryOperations> countProperty() {
    return QueryBuilder.apply(this, (query) {
...
const DiarySchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'timeline': LinkSchema(
      id: 4473749095609519167,
      name: r'timeline',
      target: r'TimeLine',
      single: true,
    )
  },
  embeddedSchemas: {r'DiaryContent': DiaryContentSchema},
  getId: _diaryGetId,
...
int _diaryEstimateSize(
  ...
  var bytesCount = offsets.last;
  {
    ...
    if (value != null) {
      bytesCount += 3 +
          DiaryContentSchema.estimateSize(
...
void _diarySerialize(
  ...
  writer.writeObject<DiaryContent>(
    offsets[0],
    allOffsets,
...
Diary _diaryDeserialize(
  ...
  final object = Diary(
    content: reader.readObjectOrNull<DiaryContent>(
      offsets[0],
...
P _diaryDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectOrNull<DiaryContent>(
        offset,
        DiaryContentSchema.deserialize,
        allOffsets,
      )) as P;
...
void _diaryAttach(IsarCollection<dynamic> col, Id id, Diary object) {
  object.id = id;
  object.timeline.attach(col, col.isar.collection<TimeLine>(), r'timeline', id);
}
...
extension DiaryQueryFilter on QueryBuilder<Diary, Diary, QFilterCondition> {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'tag',
        value: '',
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'tag',
        value: '',
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'tag',
        0,
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'tag',
        0,
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> tagLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DiaryQueryObject on QueryBuilder<Diary, Diary, QFilterCondition> {
  QueryBuilder<Diary, Diary, QAfterFilterCondition> content(
      FilterQuery<DiaryContent> q) {
    return QueryBuilder.apply(this, (query) {
...
extension DiaryQueryLinks on QueryBuilder<Diary, Diary, QFilterCondition> {
  QueryBuilder<Diary, Diary, QAfterFilterCondition> timeline(
      FilterQuery<TimeLine> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'timeline');
    });
  }

  QueryBuilder<Diary, Diary, QAfterFilterCondition> timelineIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'timeline', 0, true, 0, true);
    });
  }
}
...
extension DiaryQueryProperty on QueryBuilder<Diary, Diary, QQueryProperty> {
  ...
  QueryBuilder<Diary, List<String>, QQueryOperations> tagProperty() {
    return QueryBuilder.apply(this, (query) {
...
const DiaryContentSchema = Schema(
  name: r'DiaryContent',
  id: -2594542018096952471,
  properties: {
  ...
  estimateSize: _diaryContentEstimateSize,
  serialize: _diaryContentSerialize,
  deserialize: _diaryContentDeserialize,
  deserializeProp: _diaryContentDeserializeProp,
);

int _diaryContentEstimateSize(
  DiaryContent object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  ...
  bytesCount += 3 + object.music.length * 3;
  {
    for (var i = 0; i < object.music.length; i++) {
      final value = object.music[i];
      bytesCount += value.length * 3;
    }
  }
...
void _diaryContentSerialize(
  DiaryContent object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  writer.writeStringList(offsets[0], object.image);
  writer.writeStringList(offsets[1], object.music);
  writer.writeString(offsets[2], object.text);
}

DiaryContent _diaryContentDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = DiaryContent(
    image: reader.readStringList(offsets[0]) ?? const [],
    music: reader.readStringList(offsets[1]) ?? const [],
    text: reader.readStringOrNull(offsets[2]) ?? '',
  );
  return object;
}

P _diaryContentDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension DiaryContentQueryFilter
    on QueryBuilder<DiaryContent, DiaryContent, QFilterCondition> {
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition>
      imageElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition>
      imageElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'image',
        wildcard: pattern,
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition>
      musicElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'music',
        value: value,
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition>
      musicElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'music',
        wildcard: pattern,
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition> textEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition> textLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition> textBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition> textEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition> textContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<DiaryContent, DiaryContent, QAfterFilterCondition> textMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension DiaryContentQueryObject
    on QueryBuilder<DiaryContent, DiaryContent, QFilterCondition> {}
