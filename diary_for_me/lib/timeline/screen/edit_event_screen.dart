...
class _ActivityEditContentState extends State<_ActivityEditContent> {
  ...
  void _saveChanges () {
    if (_formKey.currentState!.validate()) {
      ...
      _resultEvent.timestamp = _resultEvent.timestamp.copyWith(hour: newHour, minute: newMinute);
                          ...
                          child: Row(
                            children: [
                              ...
                              DropdownButton<int>(
                                ...
                                onChanged: (v) => setState(() => newHour = v!),
                              ...
                              DropdownButton<int>(
                                ...
                                onChanged: (v) => setState(() => newMinute = v!),
                                style: TextStyle(fontSize: 15.0, fontWeight: FontWeight.w400, color: textPrimary),
                              ),
                            ],
                          ),
                        ...
                        children: [
                          Expanded(
                            child: ContainerButton(
                              shadows: [
                                BoxShadow(
                                  color: liked ? Colors.redAccent.withAlpha(128) : Colors.transparent,
                                  spreadRadius: -12,
                                  blurRadius: 18,
                                  offset: Offset(0, 18),
                                )
                              ],
                              color: liked? Colors.redAccent : Colors.transparent,
                              height: 56,
                              borderRadius: BorderRadius.circular(20),
                              ...
                              child: Center(
                                child: Row(
                                  ...
                                  children: [
                                    Icon(
                                      Icons.thumb_up,
                                      color: liked ? Colors.white : textTertiary,
                                      size: 20,
                                    ),
                                    SizedBox(width: 8),
                                    Text(
                          ...
                          Expanded(
                            child: ContainerButton(
                              shadows: [
                                BoxShadow(
                                  color: !liked ? Colors.blueAccent.withAlpha(128) : Colors.transparent,
                                  spreadRadius: -12,
                                  blurRadius: 18,
                                  offset: Offset(0, 18),
                                )
                              ],
                              color: !liked? Colors.blueAccent : Colors.transparent,
                              height: 56,
                              borderRadius: BorderRadius.circular(20),
